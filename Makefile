...
SRCS := source/list.c source/set.c source/queue.c source/bitree.c source/bistree.c source/dlist.c source/stack.c source/heap.c source/events.c source/cvector.c source/avl-tree.c source/circular_buffer.c
